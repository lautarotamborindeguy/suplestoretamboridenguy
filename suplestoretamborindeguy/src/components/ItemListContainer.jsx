...
function ItemListContainer () {
    function productosItem (){
        return new Promise((resolve, reject) =>{
            setTimeout(() => {
                let productos = [{id: 1, nombre: 'Whey Protein', descripcion: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', precio: 2000, urlImages: 'images/wheyprotein.jpg', altImages: 'Imagen del Producto', stock: 3}, {id: 2, nombre: 'Creatina', descripcion: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', precio: 500, urlImages: 'images/wheyprotein.jpg', altImages: 'Imagen del Producto', stock: 5}, {id: 3, nombre: 'Bcaa', descripcion: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', precio: 1000, urlImages: 'images/wheyprotein.jpg', altImages: 'Imagen del Producto', stock: 0}]
    ...
    let arrayProductos = productosItem().then((resultado) => {
        return resultado
    })
